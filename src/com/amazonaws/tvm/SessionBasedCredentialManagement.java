...
public class SessionBasedCredentialManagement {
	
	protected static final Logger log = TokenVendingMachineLogger.getLogger();
	
	public static Credentials getSessionCredentials( String username ) {
		if ( ( Configuration.AWS_ACCESS_KEY_ID == null ) || ( Configuration.AWS_SECRET_KEY == null ) || username == null ) {
			...
			try {
				...
				getFederationTokenRequest.setPolicy( SessionBasedCredentialManagement.getPolicyObject() );
				...
				log.log( Level.SEVERE, "Exception during getSessionCredentials", exception );
				return null;
			}
		}
	}
