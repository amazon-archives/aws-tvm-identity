...
/**
 * This interface exposes key functions performed by Token Vending Machine. TVM (Token Vending Machine) operates in 2 modes i.e. Anonymous and
 * Identity. Anonymous mode is suitable for use-cases which allows anybody and everybody to get tokens necessary to access AWS resources. Identity
 * mode is more useful when application developer needs to track their customer and how much resources each of them is using. This mode is also
 * suitable to when application developer wants to charge as per usage.
 */
